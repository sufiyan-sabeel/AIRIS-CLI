...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".airis/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".airis/agent/extensions/edit.ts");
