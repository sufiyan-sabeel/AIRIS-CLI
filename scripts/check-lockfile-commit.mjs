...
const allowValue = process.env.AIRIS_ALLOW_LOCKFILE_CHANGE;
...
if (allowed) {
	console.error("package-lock.json is staged; AIRIS_ALLOW_LOCKFILE_CHANGE is set, allowing commit.");
	process.exit(0);
}
...
console.error("  AIRIS_ALLOW_LOCKFILE_CHANGE=1 git commit ...");
process.exit(1);
