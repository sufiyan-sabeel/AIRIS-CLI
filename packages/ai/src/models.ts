...
type ModelId<TProvider extends KnownProvider> = TProvider extends GeneratedProvider
	? keyof (typeof MODELS)[TProvider]
	: string;
type ModelApi<TProvider extends KnownProvider, TModelId extends PropertyKey> = TProvider extends GeneratedProvider
