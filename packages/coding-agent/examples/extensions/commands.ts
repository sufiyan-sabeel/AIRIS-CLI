 ...
 * Commands Extension
 *
 * Demonstrates the airis.getCommands() API by providing a /commands command
...
export default function commandsExtension(airis: ExtensionAPI) {
	airis.registerCommand("commands", {
