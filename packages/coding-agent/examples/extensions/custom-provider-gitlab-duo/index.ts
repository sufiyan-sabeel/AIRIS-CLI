 ...
 * Delegates to airis-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   airis -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (airis: ExtensionAPI) {
	airis.registerProvider("gitlab-duo", {
