...
Play DOOM as an overlay in airis. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
airis --extension ./examples/extensions/doom-overlay
```
...
- [airis-doom](https://github.com/sufiyan-sabeel/AIRIS-CLI-doom) for the original airis integration
