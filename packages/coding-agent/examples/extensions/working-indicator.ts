 ...
 * working indicator shown while airis is streaming a response.
 *
 * Usage:
 *   airis --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore airis's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@sufiyan-sabeel/airis-cli";
...
export default function (airis: ExtensionAPI) {
	...
	airis.registerCommand("working-indicator", {
