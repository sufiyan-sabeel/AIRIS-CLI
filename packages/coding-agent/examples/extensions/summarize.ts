...
import type { ExtensionAPI, ExtensionCommandContext } from "@earendil-works/airis-coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@earendil-works/airis-coding-agent";
