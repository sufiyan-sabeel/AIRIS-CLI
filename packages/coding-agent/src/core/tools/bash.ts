...
/**
 * Create bash operations using airis's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want airis's
