 ...
 * Encodes cwd into a safe directory name under ~/.airis/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.airis/agent/sessions/<encoded-cwd>/).
	 */
