...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@sufiyan-sabeel/airis-cli` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@sufiyan-sabeel/airis-cli";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown airis and exit. Available in all contexts. */
	shutdown(): void;
...
export interface BeforeAgentStartEvent {
	...
	systemPrompt: string;
	/** Structured options used to build the system prompt. Extensions can inspect this to understand what AIRIS loaded without re-discovering resources. */
...
/** Configuration for registering a provider via airis.registerProvider(). */
...
export type ExtensionFactory = (airis: ExtensionAPI) => void | Promise<void>;
...
/**
 * Action implementations for airis.* API methods.
