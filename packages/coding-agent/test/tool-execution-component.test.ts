...
import { Text, type TUI } from "@earendil-works/airis-tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".airis", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .airis/AGENTS.md",
	...
	for (const scenario of [
		...
		{ title: "AIRIS documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {
