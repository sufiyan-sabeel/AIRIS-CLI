...
import type { AssistantMessage, Model } from "@earendil-works/airis-ai";
...
vi.mock("@earendil-works/airis-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@earendil-works/airis-ai")>();
	return {
		...actual,
