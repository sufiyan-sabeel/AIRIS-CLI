...
import type { AssistantMessage, Model } from "@sufiyan-sabeel/airis-ai";
...
vi.mock("@sufiyan-sabeel/airis-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@sufiyan-sabeel/airis-ai")>();
	return {
		...actual,
